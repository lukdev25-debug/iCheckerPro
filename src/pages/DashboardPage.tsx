        ...
        {tab === 'wallet' && (
          <div className="mx-auto max-w-lg space-y-6">
            ...
            <div className="card-base">
              ...
              <p className="mb-6 text-sm text-muted">Add funds via MercadoPago (credit card, debit, or transfer).</p>
              ...
              >
                {topupLoading ? (
                  ...
                  <>
                    ...
                    Pay ${topupAmount} with MercadoPago
                  </>
                )}
              </button>
              ...
              <p className="mt-4 flex items-center justify-center gap-1.5 text-xs text-muted">
                ...
                You'll be redirected to MercadoPago's secure checkout
              </p>
            </div>
          </div>
        )}
