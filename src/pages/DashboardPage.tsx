        ...
        {tab === 'wallet' && (
          <div className="mx-auto max-w-lg space-y-6">
            ...
            <div className="card-base relative overflow-hidden">
              <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full opacity-10 blur-[60px]" style={{ background: 'radial-gradient(circle, #66FF33 0%, transparent 7[...'}></div>
