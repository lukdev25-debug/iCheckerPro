...
const SERVICES = [
  ...
  // Apple GSX / Details
  { id: 'gsx_premium', name: 'GSX Premium Details', price: 4.00, desc: 'Full GSX report', category: 'Apple GSX' },
    ...
    try {
      if (topupMethod === 'mercadopago') {
        ...
        if (!res.ok) {
          ...
          // Prefer production checkout URL (init_point). Use sandbox only as a fallback.
        ...
        {tab === 'wallet' && (
          <div className="mx-auto max-w-lg space-y-6">
            ...
            <div className="card-base relative overflow-hidden">
              <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full opacity-10 blur-[60px]" style={{ background: 'radial-gradient(circle, #66FF33 0%, transparent 7[...]
